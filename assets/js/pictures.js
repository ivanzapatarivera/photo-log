      ...
      .then((data) => {
        ...
        data.map((data) => {
          ...
          eventPictureClick.addEventListener("click", function (event) {
            ...
            eventPicDiv.classList.add('fade-in'); // Using animista URL: https://animista.net/play/entrances/fade-in/fade-in
            ...
            eventPicDiv.addEventListener("click", function () {
              if (eventPicDiv) {
                ...
                eventPicDiv.classList.remove('fade-in'); // Using animista URL: https://animista.net/play/entrances/fade-in/fade-in-fwd
